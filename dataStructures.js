...
// time complexity: O(nlogn) Because of the sort method, this solution is not very time efficient
...
// time complexity: O(n+m) Both arrays are interated over only once.
